...
//
// ExecuteFunctionXmlAs calls the function and unmarshals the response result to type T with XML struct tags.
// It uses [mapToXmlStruct] for conversion with struct tags in xml:"..." format.
//
// Returns the function result as type T, or an error if the call fails or type conversion fails.
//
// Example:
...
//
// ExecuteActionXmlAs calls the action and unmarshals the response result to type T with XML struct tags.
// It uses [mapToXmlStruct] for conversion with struct tags in xml:"..." format.
//
// Returns the action result as type T, or an error if the call fails or type conversion fails.
//
